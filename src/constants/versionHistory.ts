...
export const VERSION_HISTORY: VersionRelease[] = [
  {
    version: 'v3.4.0',
    date: '14/09/2026',
    title: 'Tùy Chọn Ngày Vay Trên Trang Vay/Trả',
    isLatest: true,
    tagline: 'Phiên bản mới nhất',
    changes: [
      'Cho phép linh hoạt chọn ngày thực hiện giao dịch mượn (vay) bao bì thay vì chỉ cố định thời điểm hiện tại.',
      'Tích hợp nút chọn nhanh hôm nay và hiển thị định dạng ngày tháng rõ ràng, trực quan.',
      'Đồng bộ chính xác mốc thời gian đã chọn vào lịch sử phiếu vay, nhật ký hoạt động và các báo cáo định kỳ.'
    ]
  },
  {
    version: 'v3.3.1',
